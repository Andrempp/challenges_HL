 ...
 */
public class F2GAnnotations {

	public int minsup;
	protected List<List<Integer>> dataset;
	protected List<List<Integer>> annotations;
	...
	public F2GAnnotations() {}
	public F2GAnnotations(List<List<Integer>> _dataset){ setData(_dataset); }
