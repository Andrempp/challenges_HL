...
import bicpam.pminer.fim.fpgrowth.weka.MaximalFPGrowthTID;
 ...
 * @version 1.0
 */
public class BicMaximalFPGrowthTID extends MaximalFPGrowthTID implements BicPM {
  
  private static final long serialVersionUID = 1L;

  public BicMaximalFPGrowthTID(Instances data){
	  super(data);
  }
